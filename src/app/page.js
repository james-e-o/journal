...
export default function Home() {
  ...
  {
    name: "Michael O.",
    comment: "I’ve been trading for a few years, and I can confidently say this is the most complete trading journal I’ve ever used. The way it breaks down my trades, shows performance stats, and helps me understand where I’m going wrong is simply brilliant. It’s like having a personal trading coach built into the platform.",
  },
  {
    name: "Sophia T.",
    comment: "Before using this journal, I used to keep all my trade notes in Excel, which was messy and time-consuming. Now everything is automated and well-organized. The performance analytics are clear, and the visualizations help me see my progress in ways I never could before.",
  },
  {
    name: "David K.",
    comment: "This trading journal has really improved my discipline. The daily summaries, win-rate tracking, and detailed trade reviews keep me focused on what truly matters—consistency. I also love how smooth and modern the interface feels; it’s a joy to use every day.",
  },
  {
    name: "Rachel N.",
    comment: "I used to forget why I entered or exited trades, but not anymore. With this journal, I can easily tag setups, add screenshots, and review my thought process later. It’s become an essential part of my trading routine, and I honestly feel more confident in my decisions now.",
  },
  {
    name: "James L.",
    comment: "The integration with my MT5 account is seamless. All my trades sync automatically, and I can review everything in one place without switching tabs. The profit/loss tracking and performance charts are so clear that I barely touch spreadsheets anymore.",
  },
  {
    name: "Amaka E.",
    comment: "I’m still learning to trade, and this journal has been a game changer for me. It shows me my trading patterns, mistakes, and emotional tendencies. I didn’t realize how much journaling could impact my growth until I started using this platform. Highly recommended!",
  },
  {
    name: "Carlos M.",
    comment: "The journaling process is fast and beautifully designed. What I appreciate most is how it encourages reflection after every trade. I’ve started spotting repetitive mistakes that cost me money before. My trading is getting sharper thanks to this tool.",
  },
  {
    name: "Emma R.",
    comment: "This is more than a trading journal—it’s an accountability system. The charts, performance metrics, and review tools push me to stay disciplined. I’ve seen my win rate and consistency improve dramatically since I started using it a few months ago.",
  },
];
        ...
        <main id="landing-main" className="flex bg-white pb-12 flex-col">
          <div className="">
            <div className="w-[95%] mx-auto  py-12 px-4 md:px-9">
              <p className="text-2xl w-full md:text-4xl flex text-center justify-center items-center mt-12 md:mt-20 mb-8 font-bold">
                {/* <span className="text-zinc-900  z-50   mr-2">What is in</span> 
                <Image
                ...
                priority
              /> */}
                 <span className="font-bold">How Our Platform Improves your Profitability</span>
              </p>
...
const CommentCard = ({comment,name}) => {
  return (
    <div className="flex-col font-WixMade w-full gap-5 justify-start flex ">
      ...
      <div className="md:flex tracking-tighter flex gap-2 items-center">
          ...
          <div className="flex-col justify-center leading-tight flex">
              ...
              {/* <p className="text-xs font-semibold text-core_contrast/70">staffmail@xyz</p> */}
          </div>
        </div>
    </div>
  )
...
export  function TradingBenefits() {
  ...
  {
    icon: ShieldCheck,
    title: "Master Trade Risk Control",
    desc: "Track your risk-to-reward ratios easily and protect your capital with smarter trade management.",
  },
  {
    icon: Zap,
    title: "Trade With Confidence",
    desc: "Build discipline and clarity through journaling. No more second-guessing your entries.",
  },
  {
    icon: RotateCcw,
    title: "Bounce Back After Losses",
    desc: "Every loss is a lesson. Learn from setbacks and come back stronger each session.",
  },
  {
    icon: CalendarDays,
    title: "Spot Your Best & Worst Days",
    desc: "Identify what drives your winning and losing trades so you can refine your edge.",
  },
  {
    icon: LineChart,
    title: "Find Your Winning Strategy",
    desc: "Analyze your setups and uncover which patterns deliver the highest consistency.",
  },
  {
    icon: Rocket,
    title: "Level Up Your Trading Game",
    desc: "Use journal insights to scale your strategy with focus and precision.",
  },
];
  return (
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {benefits.map((item, i) => (
          <div
            key={i}
            className="
              group relative overflow-hidden border border-core rounded-2xl p-8 
              shadow-sm bg-white cursor-pointer
          ...
          >
            ...
            <div
              className="
                absolute inset-0 bg-gradient-to-br from-black via-zinc-900 to-core 
...
//           <div
//             key={i}
//             className="border border-yellow-300 rounded-2xl p-8 shadow-sm hover:shadow-lg transition bg-white"
//           >
//             <div className="flex items-center gap-4 mb-4">
//               <item.icon className="text-core w-8 h-8" />
