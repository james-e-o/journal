...
export default function Home() {
  return (
    <div className="font-sans no_scroll items-center h-svh overflow-y-auto gap-16 ">
      <div className="h-svh relative flex flex-col justify-start bg-black">
        ...
        <header className="flex mt-7 font-serif justify-between border border-zinc-700 mx-auto md:w-[65%] px-[1.8rem] py-1.5 rounded-[48px] bg-white/5 items-center ">
        {/* <header className="flex  mb-7 justify-between py-2 md:py-4 md:px-7 items-center "> */}
          <div>
            <Image
              className="dark:invert scale-x-[112%]"
              src="/rayani3.png"
              alt="Next.js logo"
              width={50}
              height={50}
          ...
          <p className="flex font-Cinzel gap-2.5">
            <Button variant={'ghost'} className={'text-white cursor-pointer text-[13px] hover:bg-transparent hover:-translate-y-0.5 hover:text-amber-200 font-semibold'}>About</Button>
            <Button variant={'ghost'} className={'text-white cursor-pointer text-[13px] hover:bg-transparent hover:-translate-y-0.5 hover:text-amber-200 font-semibold'}>Blogs</Button>
            <Button variant={'ghost'} className={'text-white cursor-pointer text-[13px] hover:bg-transparent hover:-translate-y-0.5 hover:text-amber-200 font-semibold'}>Plans</Button>
          </p>
        ...
        <div className="flex items-center flex-col flex-grow justify-center">
          <p className="text-[#f1f1f1] font-sans font-bold tracking-tighter text-6xl">Journal your Trades</p>
          <p className="text-[#a9a9a9] font-sans font-bold tracking-tighter mt-3 text-6xl">Track Your Growth Journey</p>
          <div className="rounded-4xl bg-white mt-14 border-2 border-zinc-400">
            <input placeholder="Enter your email address" className={'w-50vw py-4 px-8 border-none outline-0'} />
            <Link className="" href={'/accounts/signup'}><Button className={' rounded-4xl px-8 -top-0.5 h-full font-semibold font-sans'}>Get started</Button></Link>
          </div>
        </div>
      </div>
      <main className="flex py-12 flex-col">
        <div className="flex flex-col items-center justify-start">
          ...
          <div className="w-4/5 p-12 flex flex-col mt-10 items-center gap-3 rounded-3xl bg-gradient-to-b from-[#f9d74e] to-yellow-500">
      ...
      <footer className="py-0 md:px-16">
        ...
        <div className="flex md:grid mt-8 text-xs text-zinc-800 gap-10 grid-cols-4">
          <div className=" px-5">
            ...
            <div className="flex mt-2 fill-yellow-500 gap-5">
                {instagram}
                {youtube}
                {linkedin}
                {x}
