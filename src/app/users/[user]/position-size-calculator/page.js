...
const RiskCalculator = () => {
  ...
  return (
    <div className=' font-WixMade flex flex-col items-center pb-10'>
        <Header />
      <p className='tracking-tight text-center px-6 text-base font-semibold my-4'>Position Size Calculator</p>
      <div className=' md:w-[75%] grid lg:grid-cols-9 gap-2'>
        <div className='lg:col-span-5 px-5 py-3'>
          ...
          <div className='w-full flex mt-7 mb-2 justify-center'>
            <Button disabled={!conversionRate} variant={'ghost'} className={'bg-core border-[3px]  h-9 scale-110  text-base text-black cursor-pointer font-semibold py-4 px-10'}>Calculate</Button>
          </div>
        </div>
